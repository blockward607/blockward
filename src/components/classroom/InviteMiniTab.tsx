...
export const InviteMiniTab = ({ classroomId }: InviteMiniTabProps) => {
  ...
  const generateInviteCode = async () => {
    ...
    try {
      ...
      console.log("[InviteMiniTab] Generating new invitation code for classroom:", classroomId);
      
      // Calculate expiration (90 days from now to match other components)
      const expiresAt = new Date();
      expiresAt.setDate(expiresAt.getDate() + 90);
      
      // Store the invitation code in Supabase - let database generate the token
      const { data: invitation, error: inviteError } = await supabase
        ...
        .insert({
          ...
          // invitation_token will be auto-generated by the database function
        })
        .select()
        .single();
